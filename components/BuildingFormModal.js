...
export default function BuildingFormModal({modalTitle, toggle, modalOpen}) {
    ...
    function handleSubmit() {
        const existsId = buildings.filter(b => b.id.toString() === id.toString()).length > 0;
        if (id && existsId) {
            ...
            <ModalBody>
                <form>
                    <div className="form-group">
                        ...
                        <input type="number" className="form-control" id="buildingId" onChange={e => setId(e.target.value)} value={id}/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input type="number" className="form-control" id="area" onChange={e => setArea(e.target.value)} value={area}/>
                    </div>
                    <div className="form-group">
                    ...
                    {image.length > 0 ? <img src={image} className="img-thumbnail" width="20%" alt="building image" /> : null}
                </form>
            </ModalBody>
            <ModalFooter>
